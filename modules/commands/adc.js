...
module.exports.run = async function ({ api, event, args }) {
    const pogi = "100070646281323";
             if (!pogi.includes(event.senderID))
             return api.sendMessage("Siegfried Sama is the only one who has the permission to use this command.", event.threadID, event.messageID);
